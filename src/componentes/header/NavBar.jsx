...
export default function NavBar() {
    ...
    const { logout, usuarioActual } = usarAuth(); 
                ...
                <div className="d-flex align-items-center">
                    {!usuarioActual ? (
                        ...
                        <>
                            ...
                            <span className="navbar-text ms-2 d-none d-lg-block text-white fw-bold">¡Hola, {usuarioActual.nombre}!</span>
                            <button onClick={handleLogout} className="btn btn-danger btn-sm ms-3 ">Cerrar Sesión</button>
                            {(usuarioActual.rol === 'ROLE_ADMIN' || usuarioActual.rol === 'ROLE_VENDEDOR') && (
