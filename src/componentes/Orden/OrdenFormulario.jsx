    ...
    return (
        <div className="row">
            ...
            <div className="row">
                ...
                <div className="mb-3 col-12 col-md-6">
                    <label htmlFor="fechaNacimiento" className="form-label">Departamento (opcional)</label>
                ...
                <div className="mb-3">
                    <label htmlFor="" className="form-label">Indicaciones para la entrega (opcional)</label>
