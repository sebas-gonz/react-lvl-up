...
export default function ProductoOfertaCard() {
    return (
        <div className="card card-producto">
            ...
            <div className="card-body">
                ...
                <div className="d-flex flex-column mb-3">
                    <span className="precio-descuento text-decoration-line-through">20.000</span>
                    <span className="precio-nuevo fw-bolder text-warning">$ 13.450</span>
                </div>
