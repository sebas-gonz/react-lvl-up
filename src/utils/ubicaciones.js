const comunasPorRegion = [
    ...
    },
    {
        ...
        comunas: [
            ...
            "Pudahuel", "Quilicura", "Quinta Normal", "Recoleta", "Renca", "San Miguel", "San Joaquín", "San Ramón",
            "Santiago", "Vitacura", "Puente Alto", "Pirque", "San José de Maipo", "Buin", "Calera de Tango",
            "Paine", "Alhué", "Curacaví", "El Monte", "Isla de Maipo", "María Pinto", "Melipilla", "Padre Hurtado",
            "Peñaflor", "Talagante"
        ]
    },
    {
    ...
    },
    {
        ...
        comunas: [
            "Chillán", "Chillán Viejo", "Quillón", "Quirihue", "Cobquecura", "Ninhue", "Portezuelo", "Ránquil", "Treguaco",
            "San Carlos", "Coihueco", "Ñiquén", "San Fabián", "San Nicolás",
            "Bulnes", "San Ignacio", "Pemuco", "El Carmen", "Yungay"
        ]
    },
    {
...
export const getRegiones = () => {
    return comunasPorRegion.map(item => item.region);
};

export const getComunasPorRegion = (nombreRegion) => {
    const regionEncontrada = comunasPorRegion.find(item => item.region === nombreRegion);
